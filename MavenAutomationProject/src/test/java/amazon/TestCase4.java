...
public void Tc4() throws InterruptedException {
	...
	p.Addtolist(d);
	p.cart(d);
	WebElement procedtocheckout =d.findElement(By.xpath("//input[@name='proceedToRetailCheckout']"));
	Assert.assertEquals(procedtocheckout.isEnabled(),true,"sorry,can't see checkout button");
